...
import { resetPassword } from '@/services/Agent';
...
const ResetPassword: React.FC<ResetPassword> = (props) => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-99999 flex h-screen w-full justify-center overflow-y-scroll bg-black/80 py-5 px-4 ${props.isReset === true ? 'block' : 'hidden'
        }`}
    >
